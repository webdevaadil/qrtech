  ...
  return (
      <div class={`${styles.cardbody}`}>
        <div class="row">
          ...
          <form
            class={`${styles.seachfeilds} form-inline mb-2`} 
          >
              ...
              <tbody>
                <tr>
                  ...
                  <td class="table-action text-center">
                    <a
                      href="http://3.109.219.236/personal/enquiries/23"
                      class="btn btn-primary"
                    >
                      <i class="mdi mdi-eye-outline"></i>{" "}
                    </a>
                    <a
                      href="http://3.109.219.236/personal/enquiries/23/edit"
                    ...
                    <form
                      id="delete-form23"
                      action="http://3.109.219.236/personal/enquiries/23"
                      method="POST"
                    ></form>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="table-action text-center">
                    <a
                      href="http://3.109.219.236/personal/enquiries/22"
                      class="btn btn-primary"
                    >
                      <i class="mdi mdi-eye-outline"></i>{" "}
                    </a>
                    <a
                      href="http://3.109.219.236/personal/enquiries/22/edit"
                      class="btn btn-warning"
                    >
                      <i class="mdi mdi-pencil"></i>{" "}
                    </a>
                ...
                <tr>
                  ...
                  <td class="table-action text-center">
                    <a
                      href="http://3.109.219.236/personal/enquiries/19"
                      class="btn btn-primary"
                    >
                      <i class="mdi mdi-eye-outline"></i>{" "}
                    </a>
                    <a
                      href="http://3.109.219.236/personal/enquiries/19/edit"
                      class="btn btn-warning"
                    >
                      <i class="mdi mdi-pencil"></i>{" "}
                    </a>
                ...
                <tr>
                  ...
                  <td class="table-action text-center">
                    <a
                      href="http://3.109.219.236/personal/enquiries/8"
                      class="btn btn-primary"
                    >
                      <i class="mdi mdi-eye-outline"></i>{" "}
                    </a>
                    <a
                      href="http://3.109.219.236/personal/enquiries/8/edit"
                      class="btn btn-warning"
                    >
                      <i class="mdi mdi-pencil"></i>{" "}
                    </a>
